import gradio as gr
from dubbing.logging_setup import (
    logger,
    set_logging_level,
...
import torch
import os
from dubbing.audio_segments import create_translated_audio
from dubbing.text_to_speech import (
...
from dubbing.translate_segments import (
    translate_text,
    TRANSLATION_PROCESS_OPTIONS,
    DOCS_TRANSLATION_PROCESS_OPTIONS
)
from dubbing.preprocessor import (
    audio_video_preprocessor,
    audio_preprocessor,
)
from dubbing.postprocessor import (
    OUTPUT_TYPE_OPTIONS,
...
from dubbing.language_configuration import (
    LANGUAGES,
...
from dubbing.mdx_net import (
    UVR_MODELS,
    MDX_DOWNLOAD_LINK,
    mdxnet_models_dir,
)
from dubbing.speech_segmentation import (
    ASR_MODEL_OPTIONS,
    COMPUTE_TYPE_GPU,
    COMPUTE_TYPE_CPU,
    find_whisper_models,
...
from dubbing.text_multiformat_processor import (
    BORDER_COLORS,
...
from dubbing.languages_gui import language_data, news
import copy
import logging
import json
    ...
    def multilingual_media_conversion(
        ...
        if not get_video_from_text_json:
            ...
            if not self.task_in_cache("refine_vocals", [vocal_refinement], {}):
                ...
                if vocal_refinement:
                    try:
                        from dubbing.mdx_net import process_uvr_task
        ...
        if not self.task_in_cache("acc_and_vc", [
            ...
            if voice_imitation:
                ...
                from dubbing.text_to_speech import toneconverter
...
title = "<center><strong><font size='7'>📽️ dubbing 🈷️</font></strong></center>"
